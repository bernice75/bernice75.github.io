(function () {
  ...
  if (window.__appPushDiagramsInitialized) return;
  window.__appPushDiagramsInitialized = true;

  var reducedMotion = window.matchMedia("(prefers-reduced-motion: reduce)");
  var figures = Array.prototype.slice.call(
    document.querySelectorAll("[data-app-push-diagram]")
  );
  ...
  figures.forEach(function (figure) {
    ...
    var delay = Number(figure.getAttribute("data-delay")) || 2400;
    var activeStep = 0;
    ...
    function captionFor(index) {
      ...
      return step ? step.getAttribute("data-caption") || "" : "";
    }
    ...
    function render() {
      ...
      if (caption) caption.innerHTML = captionFor(activeStep);
      if (playButton) {
    ...
    if (expandButton) {
      expandButton.addEventListener("click", function () {
        ...
        document.body.classList.toggle("apd-expanded", expanded);
      });
    }
  ...
  document.addEventListener("keydown", function (event) {
    ...
    document.body.classList.remove("apd-expanded");
  });
})();
